...
void posicionar_navio(char[][TAM_MAPA], short int, char);
...
int main(void)
{
    ...
    posicionar_navio(nav_mapa_p1, 5, 'P');
    posicionar_navio(nav_mapa_p1, 4, 'E');
    posicionar_navio(nav_mapa_p1, 3, 'C');
    posicionar_navio(nav_mapa_p1, 2, 'S');

    posicionar_navio(nav_mapa_p2, 5, 'P');
    posicionar_navio(nav_mapa_p2, 4, 'E');
    posicionar_navio(nav_mapa_p2, 3, 'C');
    posicionar_navio(nav_mapa_p2, 2, 'S');
...
void posicionar_navio(char mapa[][TAM_MAPA], short int tam_navio, char navio)
{
    /* Randomizacao */
    time_t t;
    srand((unsigned)time(&t));

    short int j, ran_x, ran_y, check;
